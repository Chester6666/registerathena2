...
.setDescription(`<a:space:821029395099025418> **Toplam Kayıtların:** \`${kayıtlar}\`
<a:yildiz:821029396835598356> **Toplam Erkek Kayıtların:** \`${erkek}\`
<a:kelebek:821029416808349737> **Toplam Kadın Kayıtların:** \`${kadın}\``)
.setColor('#dcdd64')
...
exports.conf = {
    enabled: true,
    guildOnly: true,
    aliases: ["kayıt-say","kayıtsay", "stat", "stats"],
    permLvl: 0,
}
